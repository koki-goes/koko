...
- reminder functionality is not exposed in commands or docs
- no separate task-completion command is exposed in commands or docs
- no AI-specific behavior is implied in the user-facing docs
